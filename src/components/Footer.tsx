...
const Footer = () => {
  ...
  return (
    <footer className="bg-core-dark text-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-core-orange transition-colors"
              >
                <Instagram size={20} />
              </a>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Home", "Sobre", "Equipamentos", "Serviços", "Contato"].map(
                (link) => (
                  <li key={link}>
                    <a
                      href={`#${link.toLowerCase()}`}
                      className="text-gray-400 hover:text-core-orange transition-colors"
                    >
                      {link}
                    </a>
                  </li>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-gray-400 hover:text-core-orange transition-colors"
                >
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-gray-400 hover:text-core-orange transition-colors"
                >
